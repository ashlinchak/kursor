...
describe Admin::Adv::CategoriesController do
  fixtures :all
  render_views
  ...
  it "create action should redirect when model is valid" do
    ...
    post :create
    response.should redirect_to(admin_adv_category_url(assigns[:category]))
  end
  ...
  it "destroy action should destroy model and redirect to index action" do
    ...
    response.should redirect_to(admin_adv_categories_url)
